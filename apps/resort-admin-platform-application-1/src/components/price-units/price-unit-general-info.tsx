...
export interface PriceUnitGeneralInfoProps {
  ...
  onFormChange: (patch: Partial<PriceUnitFormState>) => void;
  priceUnitId?: number;
...
export function PriceUnitGeneralInfo({
  mode,
  form,
  onFormChange,
  priceUnitId,
      ...
      <Card>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="pu-code" className="text-xs font-medium">{t("common.code")} *</Label>
            <Input
              id="pu-code"
              value={form.code}
          ...
          <div className="space-y-2">
            <Label htmlFor="pu-sort" className="text-xs font-medium">{t("field.sort")} *</Label>
            <Input
              id="pu-sort"
              type="number"
              value={sortValue}
