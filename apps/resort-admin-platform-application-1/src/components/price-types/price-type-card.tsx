...
import type { PriceTypeSummary } from "@/services/price-types"

interface PriceTypeCardProps {
  data: PriceTypeSummary
  onEdit: (data: PriceTypeSummary) => void
  onDelete: (id: number) => Promise<void>
}

export function PriceTypeCard({ data, onEdit, onDelete }: PriceTypeCardProps) {
