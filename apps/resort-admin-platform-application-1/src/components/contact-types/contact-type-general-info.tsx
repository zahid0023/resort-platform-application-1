...
export interface ContactTypeGeneralInfoProps {
  ...
  onFormChange: (patch: Partial<ContactTypeFormState>) => void;
...
export function ContactTypeGeneralInfo({
  mode,
  form,
  onFormChange,
  contactTypeId,
      ...
      <Card>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="ct-code" className="text-xs font-medium">{t("common.code")} *</Label>
            <Input
              id="ct-code"
              value={form.code}
              onChange={(e) => {
          ...
          <div className="space-y-2">
            <Label htmlFor="ct-sort" className="text-xs font-medium">{t("field.sort")} *</Label>
            <Input
              id="ct-sort"
              type="number"
              value={sortValue}
