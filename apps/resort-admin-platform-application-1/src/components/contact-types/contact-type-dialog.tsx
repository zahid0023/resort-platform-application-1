...
export function ContactTypeDialog({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success(t("contactType.created"));
      onOpenChange(false);
      await onSaved?.();
    } catch (err) {
  ...
  const headerTitle = mode === "create"
    ? t("contactTypeDialog.create")
    : (isEditing ? t("contactTypeDialog.edit") : t("contactTypeDialog.view"));
  const headerDesc = mode === "create"
    ? t("contactTypeDialog.descCreate")
    : (isEditing ? t("contactTypeDialog.descEdit") : t("contactTypeDialog.descView"));
