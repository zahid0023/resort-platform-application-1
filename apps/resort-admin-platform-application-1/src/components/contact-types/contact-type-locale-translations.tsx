              ...
              {form.locales.map((row, idx) => {
                ...
                return (
                  <div key={`e_${row.id}`} className="p-4 space-y-3">
                    ...
                    <LocaleFields row={row} disabled availableLocales={availableLocales} onChange={() => {}} />
                  </div>
                );
              })}
            </div>
              ...
              {form.locales.map((row, idx) => {
                ...
                return (
                  <div key={idx} className="p-4 space-y-3">
                    ...
                    <LocaleFields row={row} disabled={false} availableLocales={availableLocales} usedIds={usedIds} localeSelectable onChange={(patch) => updateLocaleRow(idx, patch)} />
                  </div>
                );
              })}
            </div>
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder={t("contactTypeDialog.namePlaceholder")}
          disabled={disabled}
          className="h-9 text-sm"
        />
      </div>
      <div className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder={t("contactTypeDialog.descriptionPlaceholder")}
          disabled={disabled}
          rows={2}
