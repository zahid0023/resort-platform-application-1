...
export function ResortPermissionTypeDialog({
  ...
  const headerTitle = mode === "create"
    ? t("resortPermissionTypeDialog.new")
    : (isEditing ? t("resortPermissionTypeDialog.edit") : t("resortPermissionTypeDialog.view"));
  const headerDesc = mode === "create"
    ? t("resortPermissionTypeDialog.desc.create")
    : (isEditing ? t("resortPermissionTypeDialog.desc.edit") : t("resortPermissionTypeDialog.desc.view"));
