...
export type BedTypeDialogMode = "create" | "edit" | "view";
...
export interface BedTypeFormState {
  code: string;
  sort_order: number;
  /** Create mode only — the single "en" translation created alongside the bed type */
