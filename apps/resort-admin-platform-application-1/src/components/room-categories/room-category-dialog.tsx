...
export function RoomCategoryDialog({
  ...
  const headerTitle = mode === "create"
    ? t("roomCategoryDialog.create")
    : (isEditing ? t("roomCategoryDialog.edit") : t("roomCategoryDialog.view"));
  const headerDesc = mode === "create"
    ? t("roomCategoryDialog.descCreate")
    : (isEditing ? t("roomCategoryDialog.descEdit") : t("roomCategoryDialog.descView"));
