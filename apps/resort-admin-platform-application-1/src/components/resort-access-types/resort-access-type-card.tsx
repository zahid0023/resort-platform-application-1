...
import type { ResortAccessTypeSummary } from "@/services/resort-access-types"

interface ResortAccessTypeCardProps {
  data: ResortAccessTypeSummary
  onEdit: (data: ResortAccessTypeSummary) => void
  onDelete: (id: number) => Promise<void>
}

export function ResortAccessTypeCard({ data, onEdit, onDelete }: ResortAccessTypeCardProps) {
