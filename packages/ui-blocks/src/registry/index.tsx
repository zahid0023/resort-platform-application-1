...
export const UI_BLOCKS_INDEX: UiBlockMeta[] = [
  {
    ...
    category: hero1Schema.category as UiBlockCategoryKey,
    component: Hero1 as ComponentType<Record<string, unknown>>,
    schema: hero1Schema as UiBlockSchema,
  ...
  },
  {
    ...
    category: hero4Schema.category as UiBlockCategoryKey,
    component: Hero4 as ComponentType<Record<string, unknown>>,
    schema: hero4Schema as UiBlockSchema,
  ...
  },
  {
    ...
    category: gallery1Schema.category as UiBlockCategoryKey,
    component: Gallery1 as ComponentType<Record<string, unknown>>,
    schema: gallery1Schema as UiBlockSchema,
  ...
  },
  {
    ...
    category: gallery4Schema.category as UiBlockCategoryKey,
    component: Gallery4 as ComponentType<Record<string, unknown>>,
    schema: gallery4Schema as UiBlockSchema,
